...
const PAGE_DATA = {
  ...
  benefits: [
    "Triple your daily outbound call volume",
    "Drastically reduce agent idle and wait times",
    "Maintain strict compliance with built-in DNC scrubbing",
    "Filter out 95%+ of answering machines and bad numbers",
    "Seamless CRM integration for instant screen-pops",
...
const ENTERPRISE_FEATURES = [
  ...
  { icon: Headphones, title: "24/7 Support", description: "Never skip a beat. Secure 24/7 dedicated support for your critical outbound campaigns." },
  { icon: BrainCircuit, title: "AI Call Management", description: "Elevate your team with smart pacing algorithms, sentiment analysis, and automated QA." },
];
