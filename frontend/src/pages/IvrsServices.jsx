...
const ENTERPRISE_FEATURES = [
  ...
  { icon: BrainCircuit, title: "AI Call Management", description: "Elevate your team with smart routing algorithms, sentiment analysis, and automated QA." },
];

export default function IvrsServices() {
    ...
    <div className="bg-white text-slate-900 flex flex-col min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-16 lg:gap-20 xl:gap-28 items-center">
          ...
          <div className="relative z-10 order-1 lg:order-2">
            ...
            <h2 className="font-heading font-bold text-3xl sm:text-4xl text-slate-900 leading-snug mb-6">
              The Intelligence Behind Modern <span className="text-blue-600">IVR Solutions</span>
            </h2>
      ...
      <section className="bg-slate-50 py-10 border-b border-slate-200 border-dashed">
        <div className="max-w-7xl mx-auto px-4 text-center text-slate-400">
          <p className="font-mono text-sm">[ Reserved Space for Specific IVR Diagram / Call Flow Visualizer ]</p>
        </div>
      </section>
